...
有关在 VMware vSphere 7.0 中使用 NVMe/FC 的更多信息，请参阅 https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html["ONTAP NVMe/FC 主机配置指南"]和 https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684"]。
